...
# The analysis 
Each query was designed to answer a specific [question](#The-Main-Questions-I-Want-To-Answer) about the Machine Learning (ML) job market. Below, a few examples are given on the approach:
